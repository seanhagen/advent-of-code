...
about a "1202 program alarm". On the radio, an Elf is already explaining how to
handle the situation: "Don't worry, that's perfectly norma--" The ship computer
bursts into flames.
...
of the output (3). To handle this opcode, you first need to get the values at the input positions:
...
func main() {
	...
	fmt.Printf("value after 1202 alarm: %v\n", v)
}
