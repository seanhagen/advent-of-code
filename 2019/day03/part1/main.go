...
import (
	...
	"github.com/seanhagen/advent-of-code/2019/day03"
...
each wire takes as it leaves the central port, one wire per line of
...
func main() {
	...
	err := lib.LoopOverLines(f, func(in []byte) error {
		...
		if wireA != "" && wireB != "" && s != "" {
			return fmt.Errorf("too many wires?")
		}
