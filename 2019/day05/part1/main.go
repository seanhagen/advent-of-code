...
You're starting to sweat as the ship makes its way toward Mercury. The Elves suggest that
you get the air conditioner working by upgrading your ship computer to support the Thermal
...
Programs that use these instructions will come with documentation that explains what should
be connected to the input and output. The program 3,0,4,0,99 outputs whatever it gets as input,
then halts.
...
DE - two-digit opcode,      02 == opcode 2
 C - mode of 1st parameter,  0 == position mode (4, pos 4 = 33)
 B - mode of 2nd parameter,  1 == immediate mode (3)
...
This instruction multiplies its first two parameters.
  ...
  The result of this operation, 33 * 3 = 99, is written according to the third parameter, 4
