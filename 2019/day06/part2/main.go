...
import (
	...
	"github.com/seanhagen/advent-of-code/2019/day06"
	"github.com/seanhagen/advent-of-code/lib"
)

/*
--- Part Two ---
Now, you just need to figure out how many orbital transfers you (YOU) need to take
to get to Santa (SAN).
...
func main() {
	...
	c := day06.CreateOrbitalComputer()

	err := lib.LoopOverLines(f, func(line []byte) error {
		c.AddPlanet(string(line))
		return nil
	})
	...
	fmt.Printf("min transfers: %v\n", c.MinOrbitalTransfers())
}
