...
what you determine:
	...
	is greater than zero. (An offset of 2 skips the next instruction, an offset of
...
jgz a -2
	...
	to both be skipped (rcv because a is 0, and jgz because a is not greater than
	0).
