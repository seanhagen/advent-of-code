...
import (
	...
	"github.com/seanhagen/advent-of-code/2018/day11"
)
...
to project a hologram of the situation: a 300x300 grid of fuel cells and their current power levels,
some negative. You're not sure what negative power means in the context of time travel, but it
can't be good.
...
func main() {
	g := day11.SetupGrid(7165)
	x, y, p := g.FindLargest(3)
