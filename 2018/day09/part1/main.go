...
to very particular rules. The marbles are numbered starting with 0 and increasing by
...
marble that was just placed and the current marble.) The marble that was just placed
...
of those turns would produce circles of marbles like this, where clockwise is to the
...
(because player 5 kept marble 23 and removed marble 9, while no other player got any
