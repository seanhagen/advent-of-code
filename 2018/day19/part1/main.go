...
In detail, when running this program, the following events occur:
	...
	2, is executed. This is very similar to the instruction before it: 6 is stored
	...
	register 0 and the value 1, storing the result, 3, back in register
	0. Register 0 is then copied back to the instruction pointer, which will cause
